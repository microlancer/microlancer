Une offre a été demandée pour être annulée, plutôt que complétée.

Pour les tâches en séquestre, vous disposez de 5 jours pour ouvrir un litige en contactant le support. Assurez-vous de comprendre la raison de l'annulation avant de l'accepter. Si votre travail est déjà commencé ou terminé, vous avez le droit d'ouvrir un litige et de demander un arbitrage. Si un litige n'est pas ouvert dans les 5 jours, l'annulation sera automatiquement acceptée et tous les fonds bloqués seront restitués au propriétaire de la tâche.

Pour les tâches non-séquestre, il n'y a pas d'arbitrage des différends.
